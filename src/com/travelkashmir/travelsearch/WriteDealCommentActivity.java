...
public class WriteDealCommentActivity  extends Activity{
	Button btn_review;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_review.setOnClickListener(new View.OnClickListener() {
			...
			comment =edt_text.getText().toString().trim();
			...
			/*if(!isLogin)
			{
				...
				Toast.makeText(appContext, "Allredy Login", Toast.LENGTH_SHORT).show();
			}*/
			}
		});
	...
	public class PostReview extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			// TODO Auto-generated method stub
			serverUrl = Constant.serverUrl+ "AddComment";
			ArrayList<NameValuePair> listParams = new ArrayList<NameValuePair>();
			listParams.add(new BasicNameValuePair("userid",userId));
			listParams.add(new BasicNameValuePair("dealid",hotel_id));
			listParams.add(new BasicNameValuePair("title",title));
			listParams.add(new BasicNameValuePair("rating", ratingCount));
			listParams.add(new BasicNameValuePair("comment",comment));
